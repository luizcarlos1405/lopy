...
<div class="relative text-2xl overflow-x-visible text-center">
  ...
  {#if open}
    <div
      class="absolute flex flex-col bottom-14 -left-9 h-80 w-max rounded overflow-hidden"
      use:clickOutside
    ...
    >
      ...
      <div
        class="sticky bottom-0 z-50 p-2 bg-white rounded-b grid grid-cols-9 gap-1 justify-items-center"
      >
